...
namespace Lockbase.CoreDomain.ValueObjects  {
    ...
    public class RecurrenceRuleWeekDayOfMonth : RecurrenceRule {

        public static implicit operator RecurrenceRuleWeekDayOfMonth(string value) {

            RecurrenceRule rule = value;
            return rule as RecurrenceRuleWeekDayOfMonth;
        }

        public RecurrenceRuleWeekDayOfMonth(int multiplier, TimeInterval frequency, string values) : base(multiplier, frequency)
        {
        ...
        private static IImmutableSet<DayOfWeekSpecified> GetWeekOfDaySet(string values) {
